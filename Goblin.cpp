...
void Goblin::M_Set_attacktime(float _time)
{
	m_attackCycle = _time;
	...
	, m_IsHpUnderZero()
{
	...
	M_animeintance->M_AddAnimation(L"Resources\\enemy\\Goblin\\Goblin_IDLE.png", 1, 1, ANIMESTATUS::IDLE);
	M_animeintance->M_AddAnimation(L"Resources\\enemy\\Goblin\\Goblin_ATTACK.png", 6, 0.7f, ANIMESTATUS::ATTACK);
	M_animeintance->M_AddAnimation(L"Resources\\enemy\\Goblin\\Goblin_IDLE.png", 1, 1, ANIMESTATUS::DIE);
...
void Goblin::M_Update()
{
	...
	{
		SoundManager::GetInstance()->M_PlayEffect(SOUND_LIST::GOBLIN_ATTACK, SOUND_CHANNEL::SOUND_CHANNEL_MOSTERATTACK, 0.8f);
